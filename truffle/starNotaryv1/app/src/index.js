...
const Web3 = require("web3"); //Importing Web3 object

// import starNotaryArtifact from "../../build/contracts/StarNotary.json"; // Importing the JSON representation of the Smart Contract

const starNotaryArtifact = require("../../build/contracts/StarNotary.json"); // Importing the JSON representation of the Smart Contract
